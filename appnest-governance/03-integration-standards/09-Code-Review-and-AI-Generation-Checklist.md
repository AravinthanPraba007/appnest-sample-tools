...
- [ ] **`@sparrowengg/twigs-react`** and **`@sparrowengg/twigs-react-icons`** are listed in **`app-frontend/package.json`** (required app dependencies). Version should be **`"*"`** (latest)—do not pin to a specific version that may not exist (e.g. `^2.0.0`); see [07-Twigs-UI-Reference.md](../02-sdk/07-Twigs-UI-Reference.md).
