...
If the app uses the AppNest **$file** API (getUploadUrl, getDownloadUrl, delete, list, exists), document paths and which handlers use them. See `appnest-tools/appnest-governance/02-sdk/05-SDK-Reference.md`.
