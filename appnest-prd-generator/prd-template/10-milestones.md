...
- Frontend (if applicable): `app-frontend/src/App.jsx` and components using Twigs (`@sparrowengg/twigs-react`, `@sparrowengg/twigs-react-icons`); backend invoked via `window.appnestClient.backend.invoke`.
